  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to right,rgb(168, 168, 211),rgb(138, 141, 147))`,
        }}
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {services.map((service, index) => (
            <div
              ...
              className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center transition-transform hover:-translate-y-2 hover:shadow-xl duration-300 cursor-pointer"
            >
              {service.icon}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Experience comfort and convenience with our wide range of amenities designed to make your stay memorable
            </p>
