            ...
            <div className="md:w-2/5 bg-gradient-to-br from-black to-white-700 text-white p-8 md:p-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-gray-500 rounded-lg p-3 mt-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-gray-500 mt-4 rounded-lg p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {  /*<h3 className="text-lg font-semibold mb-3">Available Hours</h3>
                  <p className="flex justify-between"><span>24*7</span> <span>9:00 AM - 5:00 PM</span></p>*/
